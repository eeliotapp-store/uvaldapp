  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 flex flex-col items-center justify-center p-4">
      ...
      <div className="mb-8 text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Cerveceria</h1>
        <p className="text-gray-600 mt-1">Sistema de Inventario</p>
      </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors pr-12"
              />
              <button
                type="button"
